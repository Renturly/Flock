...
<div class="row-fluid">
	...
	<a style="text-align: center;" href="https://www.facebook.com" class="btn btn-warning">Bird Dog Jobs</a>
...
<script>
  ...
  const goldenEgg = async () => {
	...
	function doggingFistfuls() {
	
		location.href = "https://www.accesstheflock.io/matchTable/BirdDog";
...
<br>
	...
	<a href="<?php echo Yii::app()->createAbsoluteUrl('buyer/create'); ?>" class="btn btn-warning">Bring Me Fistfuls of Cash</a>
	 or 
	<a href="<?php echo Yii::app()->createAbsoluteUrl('portfolio/create'); ?>" class="btn btn-warning">Bring Me Renturly</a>
	</p>
	<br>
...
<table id="matches" class="table table-striped table-bordered table-hover">
	<thead>
		...
		<th><a style="color:#5dbcd2;" href="http://www.accesstheflock.io/fistfuls-of-cash">Bring Me <?php 
...
print "$" . number_format($jv, 0, '.', ',');;	
	...
	<td>
		<a href="<?php echo Yii::app()->createAbsoluteUrl('bum/users/viewProfile',array('id'=>$match->path_to_seller)); ?>"><?php echo User::model()->findByPk($match->path_to_seller)->username; ?></a> has <a id="seller" href="https://www.accesstheflock.io/portfolio/<?php echo $match->portfolio_id; ?>">$<?php echo Yii::app()->format->number(Portfolio::model()->findByPk($match->portfolio_id)->min_dollar); ?></a> Flock Gold Chain
	</td>		
</tr>
...
<?php $this->renderPartial('/matchTable/birddogging1'); 
?>
